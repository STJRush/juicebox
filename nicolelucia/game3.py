...
def doorsone():
    ...
    while True:
        ...
        if choice == "1":
            print(
                "You go through the strangely carved mahogany door.You step in a room with a wet floor and cut electrical wires everywhere.You are electricuted to death.START AGAIN."
            )
            start()
...
def shedtwo():
    ...
    while True:
        ...
        if choice == "grass":
            print(
                " You step onto the dewy grass and immediately get stung by a bee. You're allergic to bee stings and your body starts puffing up. Your throat slowly closes up, causing you to slowly and painfully suffocate to death.You died. START AGAIN."
            )
...
def kitchen():
    ...
    while True:
        ...
        if choice == "kitchen":
            print("You walk into a dingy kitchen and immediately trip over a misplaced stool. You fall and hit your head on the hard floor. Your head starts gushing blood and you bleed to death.START AGAIN.")
